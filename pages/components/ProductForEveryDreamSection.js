...
export default function ProductForEveryDreamSection({ data }) {
    ...
    () => [
      {
        ...
        highlights: ['tab-1_1.png', 'tab-1_2.png', 'tab-1_3.png', 'tab-1_4.png', 'tab-1_5.png', 'tab-1_6.png'],
        benefits: ['12g Protein', 'Good Source of Calcium', 'Simple Ingredients'],
        // ✅ Your names
      ...
      },
      {
        ...
        highlightsFolder: '/images/nutritional-highlights/highProtein',
        highlights: ['1.png', '2.png', '3.png', '4.png', '5.png'],
        benefits: ['Billions of probiotics', '0 added sugar', 'Vitamin B12', 'Only natural ingredients'],
      ...
      },
      {
        ...
        highlightsFolder: '/images/nutritional-highlights/zeroSugar',
        highlights: ['1.png', '2.png', '3.png', '4.png', '5.png'],
        benefits: ['0g sugar', '11-12g protein', '60 calories', 'Lactose-Free', 'Billions of Probiotics'],
      ...
      },
      {
        ...
        tabSecondary: 'Greek Yogurt',
        tabNote: '*Chobani® Less Sugar Greek Yogurt:\n9g sugar per 5.3oz.',
        ...
        highlightsFolder: '/images/nutritional-highlights/lessSugar',
        highlights: ['1.png', '2.png', '3.png', '4.png', '5.png'],
        benefits: [
          '40% Less sugar*',
          '12g protein',
      ...
      },
      {
        ...
        highlightsFolder: '/images/nutritional-highlights/flip',
        highlights: ['1.png', '2.png', '3.png', '4.png'],
        benefits: [
          '9-10g Protein',
          'Billions of Probiotics',
  ...
  useEffect(() => {
    const img = new Image();
    const src = isMobile ? activeTab.productImgMobile : activeTab.productImgDesktop;
    ...
    <Box sx={{ display: { xs: 'none', md: 'block' }, mt: 4 }}>
      ...
      >
        ...
        >
          ...
          {/* Right content */}
          <Box sx={{ opacity: panelReady ? 1 : 0, transition: 'opacity 0.35s ease-in' }}>
            <Typography
              variant="d2c_h3"
              component="h3"
              sx={{
            ...
            <Typography
              variant="d2c_p2"
              component="p"
              sx={{ mb: 1.2, fontFamily: 'Chobani-Serif-Regular', color: getTab(activeKey).panelFg }}
            >
            ...
            <Box sx={{ mt: 2.6, display: 'flex', gap: 3, alignItems: 'flex-start', flexWrap: 'wrap' }}>
              <Box sx={{ minWidth: 260 }}>
                <Typography
                  variant="d2c_p2"
                  component="p"
                  sx={{ mb: 1, fontFamily: 'Chobani-Serif-SemiBold', color: getTab(activeKey).panelFg }}
                >
                  Key Benefits:
                </Typography>
              ...
              {getTab(activeKey).showCompleteBox ? (
                ...
                >
                  ...
                  >
                    {[
                      { label: 'SUPPORT\nSTRENGTH', icon: '/images/icon-strength.svg' },
                      { label: 'UNLOCK\nENERGY', icon: '/images/icon-energy.svg' },
                      { label: 'FEEL\nFULL', icon: '/images/icon-feel-full.svg' },
                    ].map((it, i) => (
                      <Box key={i}>
                        <Box component="img" src={it.icon} alt="" sx={{ width: 34, height: 34, objectFit: 'contain', mb: 0.8 }} />
                        <Typography
                          variant="d2c_h5"
                          component="p"
                          sx={{
    ...
    >
      ...
      >
        ...
        <Typography
          ...
          component="p"
          align="center"
          sx={{ color: '#EAE8E1', opacity: 0.92, maxWidth: 760, mx: 'auto', mb: 2.2 }}
        >
          {sub1}
        </Typography>
